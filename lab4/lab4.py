...
if __name__ == "__main__":
    ...
    probabilities = [Decimal('0.11'), Decimal('0.10'), Decimal('0.11'), Decimal('0.12'), Decimal('0.07'),
                     Decimal('0.08'), Decimal('0.09'), Decimal('0.11'), Decimal('0.12'), Decimal('0.09')]

    letters = ['m', 'o', 's', 'k', 'a', 'l', ' ', 'v', 'd', 'y', 'n', 'r', 'i', 'c', 'h']
    letters_probabilities = [Decimal('0.035'), Decimal('0.071'), Decimal('0.071'), Decimal('0.035'),
                             Decimal('0.142'), Decimal('0.107'), Decimal('0.071'), Decimal('0.107'),
                             Decimal('0.071'), Decimal('0.107'), Decimal('0.035'), Decimal('0.035'),
                             Decimal('0.035'), Decimal('0.035'), Decimal('0.035')]
